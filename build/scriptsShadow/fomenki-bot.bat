...
set CLASSPATH=%APP_HOME%\lib\fomenki-bot-all.jar

@rem Execute fomenki-bot
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %FOMENKI_BOT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%FOMENKI_BOT_EXIT_CONSOLE%" exit 1
exit /b 1
